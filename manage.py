...
if os.getenv('C9_HOSTNAME'):
    ...
    print("App started on Cloud9, available on",
          'https://' + os.getenv('C9_HOSTNAME'))
...
@manager.command
def load_teachers():
    teachers_admin = csv.load_teachers(
        'data/teachers_admin.csv', encoding='cp1252')
...
def erd():
    ...
    try:
        ...
        eralchemy(
            '-i', app.config['SQLALCHEMY_DATABASE_URI'], '-o', 'app/static/erd.png')
