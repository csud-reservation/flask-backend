...
@manager.command
def load_teachers():
    teachers_admin = csv.load_teachers('data/teachers_admin.csv', encoding='cp1252')
...
@manager.command
def load(start_date, end_date, data_file='data/edt.csv'):
    from datetime import datetime
    """ Loads data from CSV file generated by EDT (Emploi Du Temps) """
    csv.load_reservations(
        db,
